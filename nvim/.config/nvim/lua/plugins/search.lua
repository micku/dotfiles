return {
    ...
    },
    {
        ...
        keys = {
            ...
            {"gD", "<cmd>Telescope lsp_type_definitions<cr>", desc = "Go to type definition", { noremap=true, silent=true }},
            ...
            {"<leader>fw", "<cmd>Telescope lsp_dynamic_workspace_symbols<cr>", desc = "Find symbols (LSP)"},
